...
系统采用 SSO (Single Sign-On) 登录，接入域账号，确保访问安全性。
...
- **权益追踪**：实时展示大客户礼包余额（如 ¥50,000.00）及过期时间。
- **标签维护 (Update)**：点击标签区的“管理”，为主体公司手动 **增加或移除** 业务标签（如 VIP 、重点潜客）。
![公司画像](images/product_doc/h5_company_portrait_1772970224014.png)
*图 38: 客户全景视角与 CRUD 交互看板*
