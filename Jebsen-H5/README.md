...
手机号搜索、多 OneID 切换、空状态等功能的 Mock 测试入口与预期见 **[TEST_CASES.md](./TEST_CASES.md)**。开发环境启用 Mock 后，按文档中的 **带 token 的 URL** 自测（如 `?token=xxx&phone=13800138000` 等），文档内提供可直接复制的演示 URL。
