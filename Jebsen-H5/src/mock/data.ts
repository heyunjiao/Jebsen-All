...
export const mockTagPool: TagPool[] = [
  ...
  { id: 'sc_loan_customer', name: '贷款客户', category: 'SC【必选】', categoryPath: ['业务标签', '线索经营', '售前跟进', 'SC【必选】'], required: true, color: '#B8C8B8' },
  { id: 'sc_loan_expiring', name: '贷款即将到期', category: 'SC【必选】', categoryPath: ['业务标签', '线索经营', '售前跟进', 'SC【必选】'], required: true, color: '#B8C8B8' },
