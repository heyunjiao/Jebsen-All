  ...
  try {
    ...
    // GET /api/customer/platform-sources
      ...
      const baseKeyInfo = isCompanySource
        ? { name: displayName, mobile: '13800138000', age: 0, gender: '企业', city: '上海' }
    ...
    // GET /api/customer/opportunities
      ...
      // 企业 ONEID（COMP001）商机：10 条企业类型商机
      const companyOpportunities: Opportunity[] = [
        {
          ...
          pushTarget: 'crm',
          pushStatus: '待推送',
          salesConsultant: '企业大客户经理·王珂',
          createTime: '2025-01-18 09:30:00',
          description: '企业名称：深圳市望昕实业有限公司\n客户等级：企业大客户\n累计消费：¥5,680,000\n重点车型：Taycan / Panamera\n建议动作：邀约企业高层试驾 Taycan Turbo S',
          source: 'CRM系统',
        },
        {
          id: 'OPP_COMP_002',
          ...
          description: '企业名下车辆：Taycan / Panamera\n交付日期：2024/01/10\n至今未进店首保，建议安排企业专属上门取送车服务。',
          source: 'DMS系统',
        },
        {
          id: 'OPP_COMP_003',
          ...
          description: '活动名称：企业用车轮胎关怀计划\n覆盖车辆：企业名下全部 Taycan / Panamera\n活动有效期：2025/01/15 - 2025/03/31',
          source: 'PCN系统',
        },
        {
          id: 'OPP_COMP_004',
          ...
          description: '企业行业：餐饮连锁\n合作方向：联名试驾活动 / 会员权益互通\n建议动作：约见企业决策人，推进联合营销方案。',
          source: 'CRM系统',
        },
        {
          id: 'OPP_COMP_005',
        ...
        },
        {
          ...
          description: '活动名称：空调系统免费检测\n覆盖车辆：企业名下全部 Panamera\n建议动作：给企业联系人张雪推送活动邀约短信。',
          source: 'PCN系统',
        },
        {
          id: 'OPP_COMP_007',
          ...
          description: '企业近三年每年均有新车采购，Taycan / Panamera 为主力车型；建议规划 2025 企业车队升级方案。',
          source: 'CRM系统',
        },
        {
          id: 'OPP_COMP_008',
