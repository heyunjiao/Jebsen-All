export default {
  customer: {
    ...
    placeholder: {
      ...
      birthDate: "Select or enter birthday",
    ...
    relationTag: {
      ...
      shareholder: "Shareholder/Executive",
      legalPersonRelative: "Legal Person Relative",
      employee: "Employee",
      otherCompany: "Other"
    },
    lineage: {
    ...
    profile360: {
      ...
      preferredRepairer: "Preferred repairer",
      setAsPrimaryContact: "Set as primary contact",
      setAsPreferredRepairer: "Set as preferred repairer",
      phoneFromOrderSync: "This number is synced from after-sales orders, view only",
      addressSlotsHint: "Up to 4 addresses (same as H5), fill or edit below",
      ...
      compulsoryInsuranceStartDate: "Compulsory Insurance Start Date",
      commercialInsuranceExpiryDate: "Commercial Insurance Expiry Date",
      vehicleDamageAmount: "Vehicle Damage Amount",
      driverSeatAmount: "Driver Seat Amount (10k)",
      passengerSeatAmount: "Passenger Seat Amount (10k)",
      insurancePurchaseType: "Insurance Purchase Type",
